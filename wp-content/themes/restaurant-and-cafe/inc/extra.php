...
?>
    <div class="site-info">
        ...
        if( $copyright_text ){
            ...
            echo esc_html__( 'Copyright &copy; ', 'restaurant' ) . date_i18n( esc_html__( 'Y', 'restaurant' ) ); ?> 
            <a href="<?php echo esc_url( home_url( '/' ) ); ?>"><?php echo esc_html( get_bloginfo( 'name' ) ); ?></a>.  
        <?php } ?>
        <span class="by">
        <?php echo esc_html__( 'Restaurant | Developed By', 'restaurant' ); ?>
        <a href="<?php echo esc_url( 'https://github.com/JyjyStudio' ); ?>" rel="nofollow" target="_blank"><?php echo esc_html__( 'Jyhad Ben Youssef', 'restaurant' ); ?></a>.
        <!-- <?php printf( esc_html__( 'Powered by %s', 'restaurant' ), '<a href="'. esc_url( __( 'https://github.com/JyjyStudio', 'restaurant' ) ) .'" target="_blank">Jyhad .</a>' ); ?> -->
        </span>
        <?php  
